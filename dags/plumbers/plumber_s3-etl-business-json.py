...
# [START task_sequence]
verify_file_existence_landing >> list_file_s3 >> copy_s3_file_processed_zone >> delete_s3_file_landing_zone >> process_business_data >> delete_s3_file_processed_zone >> drop_postgres_tb >> create_postgres_tb >> write_business_dt_yugabytedb
# [END task_sequence]
